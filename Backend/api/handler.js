...
module.exports = {
      postReservation: async (context, req, res) => res.status(200).json(postReservation(req)),
      ...
      deleteReservation: async (context, req, res) => res.status(200).json(deleteReservation(req))
}     